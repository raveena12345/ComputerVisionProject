...
import threading  # To prevent blocking
...
KNOWN_WIDTH = 8.0  # cm
FOCAL_LENGTH = 500  # Adjust based on your webcam
...
# Function to play sound without freezing video
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Play sound if distance is less than 20cm
            if distance < 20:
                play_alert_sound()
